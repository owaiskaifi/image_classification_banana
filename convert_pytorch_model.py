...
if __name__ == "__main__":
    ...
    torch.onnx.export(mtailor,               # PyTorch model
                    x,                  # Example input tensor
                    'resnet.onnx',    # Output file name
                    opset_version=11,   # ONNX opset version
                     
                    dynamic_axes={
                        'input': {0: 'batch_size'},  # Dynamic input axes
                        'output': {0: 'batch_size'}  # Dynamic output axes
                    })

    print("Model saved as 'resnet.onnx'")
